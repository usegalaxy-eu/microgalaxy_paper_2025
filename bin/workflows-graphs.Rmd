...
## Workflows coverage plot: Heatmap
...
ggsave(
    plot = gr, filename = paste0(outfolder, "/heatmap.png"),
    width = 10, height = 10, units = "in", dpi = 600
)

ggsave(
    plot = gr, filename = paste0(outfolder, "/heatmap.svg"),
    width = 10, height = 10, units = "in"
)

ggsave(
    plot = gr, filename = paste0(outfolder, "/heatmap.pdf"),
