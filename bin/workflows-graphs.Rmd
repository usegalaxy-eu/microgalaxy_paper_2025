...
dt1 <- workflows_dt[which(!is.na(`Suite ID`)), c("Name", "Suite ID", "Source", "Projects"), with = FALSE] |> unique()

dt1$Source   <- ifelse(dt1$Source == "WorkflowHub", "WorkflowHub", "Public servers")
dt1$Projects <- ifelse(dt1$Projects == "Intergalactic Workflow Commission (IWC)", "Intergalactic Workflow Commission (IWC)", "Other Projects") |> str_wrap(22)
