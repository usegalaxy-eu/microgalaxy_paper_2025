...
gr1 <- gr1_df |>
    ...
    geom_stream(aes(fill = Topics), color = "grey25", linewidth = .25) +
    geom_vline(xintercept = c(2010, 2015, 2020), linewidth = .5, linetype = "dotted", lineend = "round", color = "white") +
    ...
    scale_y_continuous(breaks = c(-500, -300, -200, -100, -50, 50, 100, 200, 300, 500),
                       labels = c("+500", "+300", "+200", "+100", "+50", "+50", "+100", "+200", "+300", "+500")) +
    ...
    scale_fill_manual(values = c("All" = "#4E79A7" |> lighten(.25),
                                 "Ecosystem Dynamics & Biodiversity" = "#57e19a",
                                 "Ecosystem Dynamics & Biodiversity, Health & Disease" = "#e15759",
                                 "Health & Disease" = "#e19a57")) +
