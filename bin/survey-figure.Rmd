...
gr1 <- gr1_df |>
    ...
    geom_vline(xintercept = c(2010, 2015, 2017, 2020, 2022), linewidth = .5, linetype = "dotted", lineend = "round", color = "white") +
    ...
    scale_x_continuous(expand = c(0, 0), breaks = c(2006, 2010, 2015, 2017, 2020, 2022, 2025)) +
    scale_y_continuous(breaks = c(100, 200, 200, 400, 600, 800, 1000), expand = c(0, 0), limits = c(0, 1050)) +
