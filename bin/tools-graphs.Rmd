...
a <- df2 |>
    ...
    scale_fill_manual(values = c(paletteer_d("ggsci::default_igv", ncolors - 1), "grey") |> lighten(.25), guide = guide_legend(ncol = 1, override.aes = list(size = 2.5))) +
...
d1_p <- d1 |>
    ...
    geom_line(linewidth = .25, color = "#3C3C3C") +
    geom_area(alpha = .25) +
