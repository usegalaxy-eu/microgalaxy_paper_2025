...
colnames(availability) <- availability |> colnames() |> str_remove_all("Tools|available|on") |> str_squish()
...
d = availability |> melt(id.vars = "Galaxy wrapper id", variable.factor = FALSE, value.factor = FALSE)
d = d[which(value >= 1)]
