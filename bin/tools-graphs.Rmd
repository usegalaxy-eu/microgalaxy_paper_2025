...
a1 <- ggplot(df2, aes(`Total tool usage (usegalaxy.eu)`, `No. of tool users (2022-2023) (usegalaxy.eu)`)) +
    
    geom_point(shape = 21, size = 2, stroke = .2, color = "grey96", aes(fill = cluster)) +
